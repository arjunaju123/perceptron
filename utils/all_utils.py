...
def prepare_data(df):
    #logging.info("") is way better than print statement because we get more idea about from which module the statement is coming and so on.
    logging.info("Preparing the data by segrregtaing the dependent and indepenedent variables")
